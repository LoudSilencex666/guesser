...
System.register(['../globalVars/gameMode.js', '../utills/randomixes.js', '../globalVars/canvas.js', '../globalVars/circle.js', '../globalVars/font.js', '../sprites/circle.js', '../globalVars/words.js', '../utills/scoreCounter.js'], function (_export, _context) {
    ...
    var gameMode, founder, randomix, randomixRGB, randomixV2, canvas, circleVars, font, Circle, doubleWord, updateScore, scoreCounter, startTime, gameTime, spritesrefresh;
    function gameDoubleWord() {
        ...
        canvas.ctx.fillText(doubleWord[0][0], canvas.w / 2, canvas.h / 4);
        canvas.ctx.fillText(doubleWord[0][1], canvas.w / 2, canvas.h / 4 * 3);

        if (gameTime > spritesrefresh) {
            randomixV2(canvas.w / 2 - canvas.w / 12 * doubleWord[0][0].length / 2, canvas.w / 2 + canvas.w / 12 * doubleWord[0][0].length / 2, canvas.h / 4 - font.fontSize / 2, canvas.h / 4 + font.fontSize / 2);
            ...
            randomixV2(canvas.w / 2 - canvas.w / 12 * doubleWord[0][1].length / 2, canvas.w / 2 + canvas.w / 12 * doubleWord[0][1].length / 2, canvas.h / 4 * 3 - font.fontSize / 2, canvas.h / 4 * 3 + font.fontSize / 2);
    ...
    _export('gameDoubleWord', gameDoubleWord);
